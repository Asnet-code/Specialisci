...
export default async function AdminSpecialistAdsPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <Filters basePath="/admin/specialist-ads" searchParams={sp} />
        ...
        <table className="w-full text-sm">
          <thead className="bg-white/5">
            <tr className="text-left">
              <Th label="Tytuł" />
              <Th label="Miasto" />
              <Th label="Wynagrodzenie" field="salaryFrom" searchParams={sp} />
      ...
      <Pagination basePath="/admin/specialist-ads" searchParams={sp} page={page} totalPages={totalPages} />
    </div>
  );
}
